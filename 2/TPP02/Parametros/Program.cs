...
namespace Parametros
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            resultado = FiltrarNumeros(multiplosDe: 3, numeros: numeros); //orden que quieres
            foreach (int numero in resultado)
                Console.Write("{0} ", numero);
        ...
        static void EjemploRef()
        {
            ...
            Avanzar(ref visitasVideo, ref posibleAudiencia); //ref pasa la referencia no el objeto
            Console.WriteLine("Visitas actuales: {0} - Posible audiencia: {1}", visitasVideo, posibleAudiencia);
        ...
        }//Lo util de estos metodos por referencia es que no tenemos que devolver
        //Por lo que podemos devolver mas de un valor
        ...
        ///IMPORTANTE: Los parámetros out deben ser modificados/inicializados en el método, OBLIGATORIAMENTE.
        /// 
        /// </summary>
