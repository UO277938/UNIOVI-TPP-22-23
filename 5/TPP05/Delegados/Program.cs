...
namespace Delegados
{
    class Program
    {
        ...
        public delegate bool Cumplen(Libro libro, int valor);

        public static bool MenosPaginas(Libro libro, int nPaginas)
        {
            return libro.NPages < nPaginas;
        }

        public static bool MasTarde(Libro libro, int year)
        {
            return libro.Year > year;
        }
