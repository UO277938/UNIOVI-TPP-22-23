...
namespace ProgramacionPorContratos
{
    ...
    public class AlmacenPares
    {
        ...
        public AlmacenPares(int capacidad)
        {
             ...
             */
#if DEBUG
            Invariante(); //Se comprueba con Assert, al principio y final de cada metodo (constructor solo final)
#endif
        }
        ...
        public void Insertar(int valor)
        {
            ...
            */
            ...
            Debug.Assert(_pares.Count == cantidadPrevia + 1,"Fallo en postcondición de AlmacenPares.Insertar");//Post condicion
