    ...
    public class ModelEntrega
    {
        ...
        static void ResetModel()
        {
            ...
            employees = new List<Employee> {
                ...
                new Employee ("Lucas", "Felipez", new DateTime(1950,02,20), "123", "felipe@uniovi.es", "Asturias", offices[1]),
                new Employee ("Juan", "Felipez", new DateTime(1950,02,20), "456", "felipe@uniovi.es", "Asturias", offices[1]),
                new Employee ("Fernando", "Felipez", new DateTime(1950,02,20), "789", "felipe@uniovi.es", "Asturias", offices[1]),
                new Employee ("Iker", "Felipez", new DateTime(1950,02,20), "741", "felipe@uniovi.es", "Asturias", offices[1]),

                };

            departments = new List<Department> {
                new Department ( "Mathematics", new List<Employee> {employees[4]} ),
                new Department ( "Computer Science",new List<Employee> {employees[1], employees[2], employees[6],employees[7],employees[8],employees[9]}),
            ...
            employees[6].Department = employees[7].Department = employees[7].Department
                = employees[8].Department = employees[9].Department = departments[1];
            ...
            phoneCalls = new List<PhoneCall> {
                ...
                new PhoneCall { SourceNumber = "123", DestinationNumber = "985 001", Seconds = 60, Date = new DateTime(2011,    6,  7,  20, 34, 0) },
                new PhoneCall { SourceNumber = "456", DestinationNumber = "985 005", Seconds = 03, Date = new DateTime(2011,    7,  8,  10, 40, 0) },
                new PhoneCall { SourceNumber = "789", DestinationNumber = "985 001", Seconds = 75, Date = new DateTime(2011,    7,  8,  14, 0,  0) },
            };
        }
