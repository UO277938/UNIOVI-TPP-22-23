...
namespace _02ConSincronizacion
{
    ...
    public class ColorSincro
    {
        ...
        // para que solo haya una referencia del objeto, y static para que todos usen la misma referencia
        ...
        public void Show()
        {
            ...
            // ¿Qué hace lock?
            // lo ejecuta de forma transaccional todo lo de dentro, un hilo bloquea y ninguno entra hasta 
            // que acabe
