...
namespace MasterWorkerClase
{
    ...
    public class Master
    {
        ...
        public Master(short[] vector, short[] vectorSearch, int numeroHilos)
        {
        ...
        /// </summary>
        public int CalcularNumeroRepetidos()
        {
            // Creamos los workers
            ...
            for (int i = 0; i < this.numeroHilos; i++)
            {
                ...
                workers[i] = new Worker(this.vector, this.vectorSearch, indiceDesde, indiceHasta);
            }
            // * Iniciamos los hilos.
